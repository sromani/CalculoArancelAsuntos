...
// CJS: JSON import no expone `.default` en runtime Nest
// eslint-disable-next-line @typescript-eslint/no-require-imports
const usufructoData = require("./usufructo-coefs.json") as { coefs: number[] };
const COEF_USUFRUCTO: number[] = usufructoData.coefs;
