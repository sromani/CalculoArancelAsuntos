  ...
  return (
    ...
    >
      ...
      >
        ...
        {esEdicion ? (
          <Link href="/estudio/clientes/directorio" className={useLegacyLayout ? "btn btn-secondary" : estudioBtnSecundario}>
            Cancelar
          </Link>
        ) : useLegacyLayout ? (
          <Link href="/estudio/clientes/directorio" className="btn btn-secondary">
            Cancelar
          </Link>
        ) : null}
      </div>
